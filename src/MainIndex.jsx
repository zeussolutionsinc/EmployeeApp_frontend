    ...
    createRoutesFromElements(
      <Route element={<Auth0ProviderWithNavigate />} >
        ...
        <Route path="/signup" element={<Employee_signup />} action={employeeSignupAction} />
          ...
          <Route path='/timesheet' element={<AuthenticationGuard component={DashboardV3} />}></Route>
          <Route path='/h1bform' element={<AuthenticationGuard component={H1bLanding} />}></Route>
          <Route path='/admin' element={<AuthenticationGuard component={AdminPage} />}></Route>
          <Route path='/superadmin' element={<AuthenticationGuard component={SuperAdmin} />}></Route>
        </Route>
      </Route>
    )
);
