...
//       try {
//         const sasToken =
//           "sv=2022-11-02&ss=bf&srt=sco&sp=rwdlaciytfx&se=2024-05-04T03:09:32Z&st=2024-05-03T19:09:32Z&spr=https&sig=5pzRAIVXxZFjG8j1JlaLHcRBQ4jAozPxiPe9Az%2FZFzI%3D";
...
//       let url = `/api/H1b${retrievedFormData?.registrationId ? `/${retrievedFormData.registrationId}` : `authid/${authId}`}`;
...
//       showAlert(JSON.stringify(data), "success");
...
//           showAlert("Submission failed: " + JSON.stringify(json), "error");
//         });
//       } else {
